...
if __name__ == "__main__":
    ...
    optionsDict = {}
    optionsDict["clientAddress"] = "192.168.123.138"
    optionsDict["serverAddress"] = "192.168.123.156"
    ...
    finalizado = 0          #Contador de objetivos alcanzados
    registro = []           #Registro de posiciones y observaciones
    ...
    for i in range(1, 501):
        ...
        action, best_utility = calculate_best_action(world_model, utility_model, obs_t,
        ...
        registro.append({
            'iteracion': i,
            'mejor_accion': action,
            'mejor_utilidad': float(best_utility),
            'distancia': float(distanciaT)
        })
        ...
        if distanciaT1 <= 0.3:
            ...
            print("Se han alcanzado 5 objetivos. Finalizando la demostración.\n")
            break
            """
            finalizado += 1
    ...
    #Guardar el registro en un archivo pickle
    with open('registro_iteraciones_demostracionInverso.pkl', 'wb') as f:
        pickle.dump(registro, f)

    print(f"Registro guardado: {len(registro)} iteraciones en 'registro_iteraciones_demostracion.pkl'")
