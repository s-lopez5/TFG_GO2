...
class LowState_(idl.IdlStruct, typename="unitree_go.msg.dds_.LowState_"):
    ...
    imu_state: 'sdkpy.idl.unitree_go.msg.dds_.IMUState_'
    motor_state: types.array['sdkpy.idl.unitree_go.msg.dds_.MotorState_', 20]
    bms_state: 'sdkpy.idl.unitree_go.msg.dds_.BmsState_'
