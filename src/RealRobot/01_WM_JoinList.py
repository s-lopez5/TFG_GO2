...
file1 = "training_data_1f.pkl"
file2 = "training_data_2f.pkl"
file3 = "training_data_3f.pkl"
file4 = "training_data_4f.pkl"
file5 = "training_data_5f.pkl"
file6 = "training_data_6f.pkl"  
file7 = "training_data_7.pkl"
...
#Cargar el sexto archivo
print(f"\nCargando {file6}...")
with open(file6, "rb") as f:
    data6 = pickle.load(f)
    inputs6 = data6['inputs']
    outputs6 = data6['outputs']

print(f"Forma original de inputs6: {inputs6.shape}")
print(f"Forma original de outputs6: {outputs6.shape}")

#Cargar el séptimo archivo
print(f"\nCargando {file7}...")
with open(file7, "rb") as f:
    data7 = pickle.load(f)
    inputs7 = data7['inputs']
    outputs7 = data7['outputs']

print(f"Forma original de inputs7: {inputs7.shape}")
print(f"Forma original de outputs7: {outputs7.shape}")

#Unir los arrays
print("\nUniendo arrays...")
inputs_merged = np.concatenate([inputs1, inputs2, inputs3, inputs4, inputs5, inputs6, inputs7], axis=0)
outputs_merged = np.concatenate([outputs1, outputs2, outputs3, outputs4, outputs5, outputs6, outputs7], axis=0)
...
print(f"  - Archivo 6: {inputs6.shape[0]} muestras")
print(f"  - Archivo 7: {inputs7.shape[0]} muestras")
