...
def visualizar_datos_utilidad(archivo_pickle):
    ...
    y muestra una gráfica de Distancia vs Utilidad
    ...
    plt.scatter(distancias, utilidades, alpha=0.6, edgecolors='k', linewidth=0.5)
    ...
    plt.tight_layout()
    plt.savefig('Grafica_dist_uti_100.png', dpi=300, bbox_inches='tight')
    plt.show()
