...
with open("training_data_merged_1168.pkl", "rb") as f:
    data = pickle.load(f)
    inputs = data['inputs']
...
model = keras.Sequential([
    layers.Input(shape=(6,)),  #[distanciaT, alfa_objT, alfa_robotT, actionX, actionY, actionZ]
...
#Guardar el modelo
print("\nGuardando el modelo...")
model.save("world_model_continuo_1168.keras")

#Guardar las estadísticas de normalización
with open("normalization_stats_cont.pkl", "wb") as f:
    pickle.dump({
...
print("Modelo guardado como 'world_model_continuo_1168.keras'")
print("Estadísticas guardadas como 'normalization_stats_cont.pkl'")
