...
\begin{lstlisting}[language=XML, caption=Código Scene.xml, label=lst:scene_xml]
...
\begin{lstlisting}[language=XML, caption=Código Model\_box.xml, label=lst:model_box_xml]
  <mujoco>
      <worldbody>
...
la simulación (como se puede apreciar en la figura~\ref{fig:Sim_Go2}, página~\pageref{fig:Sim_Go2}).
...
\begin{figure}[hp!]
  ...
  \caption{Ventana de simulación de MuJoCo.}
  \label{fig:Sim_Go2}
\end{figure}
...
Después de la cancelación de la fase de simulación, el desarrollo del proyecto pasó a centrarse en el entorno real con el robot cuadrúpedo Unitree Go2. Esto permitió reorientar el trabajo hacia 
...
El primer paso de esta configuración consistió en dejar completamente operativa la infraestructura de captura de movimiento. Como se explicó previamente en el apartado de Tecnologías 
...
sección \ref{sec:tecnologias_empleadas} (página \pageref{sec:tecnologias_empleadas}). 
...
información adicional que transmite el programa. Esta modificación permitió obtener la posición de cada uno de los marcadores asignados a los \gls{markerset}s para procesarla posteriormente en 
el \gls{script}.
...
cable de 15 m) para permitir al robot moverse libremente dentro del volumen de captura sin comprometer su integridad.
...
lateral, que en este caso no se utilizará y tendrá siempre el valor 0. En cuanto al último parámetro, hace referencia a la velocidad de giro sobre el eje vertical en rad/s, también con los 
...
\begin{figure}[hp!]
  ...
  \caption{Límites del espacio de trabajo.}
...
Este proceso de recolección de datos llevó aproximadamente 2 semanas trabajando 4 horas diarias en los que finalmente se recolectaron un total de 1.200 muestras que formaron el conjunto de 
...
subgráficas, una para cada uno de los valores que se utilizan como observaciones (distancia, ángulo con el objetivo y ángulo sobre sí mismo). En los tres casos se puede observar como la 
...
\begin{figure}[hp!]
  \centering
  \includegraphics[width=0.75\textwidth]{imaxes/WM/WM_predicciones.png}
...
\begin{figure}[hp!]
  ...
  \caption{Secuencia de imágenes de una ejecución del sistema deliberativo (\url{https://github.com/s-lopez5/TFG_GO2/blob/main/VideosRobot/Video1.MP4}).}
...
\begin{figure}[hp!]
  \centering
  \includegraphics[width=0.75\textwidth]{imaxes/BrazoRobot/UM_prediction_example_100_inverso.png}
...
\begin{figure}[hp!]
  \centering
  \includegraphics[width=0.75\textwidth]{imaxes/BrazoRobot/UM_training_history_100_inverso.png}
...
\begin{figure}[hp!]
  ...
  \caption{Secuencia de imagenes de una ejecución con el modelo de utilidad nuevo (\url{https://github.com/s-lopez5/TFG_GO2/blob/main/VideosRobot/Video2DemostracionInversa.MP4}).}
...
aproximadamente 30 minutos de ejecución se recolectaron un total de 8.365 muestras.
...
\begin{figure}[hp!]
  \centering
  \includegraphics[width=0.75\textwidth]{imaxes/BrazoRobot/WM_Brazo_training_metrics.png}
...
\begin{figure}[hp!]
  \centering
  \includegraphics[width=0.75\textwidth]{imaxes/BrazoRobot/WM_Brazo_Predicciones.png}
